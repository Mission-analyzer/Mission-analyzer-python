...
--
-- === MCP-РОЗМІТКА (машиночитана, для Mission Analyzer) ===
-- Рядки нижче -- структурований формат, який сканер скриптів у
-- Mission Analyzer розпізнає regex'ом (НЕ виконує Lua) для показу цих
-- команд у діалозі "Додати команду" з підписаними полями замість
-- сирих param1..4. Формат: MCP-COMMAND оголошує саму команду
-- (номер + назва мовою скрипту), MCP-PARAM -- один рядок на кожен
-- параметр, що йде ПІСЛЯ (до наступного MCP-COMMAND чи кінця блоку).
--
-- MCP-COMMAND: 80 "Старт змійки"
-- MCP-PARAM: param2 timeout "Тривалість" с
-- MCP-PARAM: param3 amplitude "Амплітуда" м
-- MCP-PARAM: param4 period "Період хвилі" с
--
-- MCP-COMMAND: 81 "Аварійна зупинка"
--
-- === ЩО РОБИТЬ ===
